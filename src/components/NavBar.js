...
import { LinkedInIcon, GithubIcon, GmailIcon, FacebookIcon, SunIcon, MoonIcon } from './Icon';
...
const CustomMobileLink = ({href,title,className="", toggle}) =>{
  ...
  return(
    <button href={href} className={`${className} relative group dark:text-dark text-light my-2`} onClick={handleClick}>
      {title}
  ...
  return (
    ...
    <div className='w-full flex justify-between items-center lg:hidden'>
      ...
      <nav className='flex items-center justify-center flex-wrap'>
        <motion.a href="https://www.linkedin.com/in/mahmud-ur-rahman-a3a1b8191" target={"_blank"} whileHover={{y:-4}} whileTap={{scale:0.9}} className="w-6 mr-3">
          <LinkedInIcon/>
        </motion.a>
        <motion.a href="https://github.com/IspahanRahman" target={"_blank"} whileHover={{y:-4}} whileTap={{scale:0.9}} className="w-6 mx-3">
          <GithubIcon />
        </motion.a>
        <motion.a href="mailto:ispahanrahman133@gmail.com" target={"_blank"} whileHover={{y:-4}} whileTap={{scale:0.9}} className="w-6 mx-3">
          <GmailIcon />
        </motion.a>
        <motion.a href="mailto:ispahanrahman133@gmail.com" target={"_blank"} whileHover={{y:-4}} whileTap={{scale:0.9}} className="w-6 ml-3 text-light">
          <FacebookIcon />
        </motion.a>
